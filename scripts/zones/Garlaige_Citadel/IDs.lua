...
zones[xi.zone.GARLAIGE_CITADEL] =
{
    text =
    {
        ...
        BOXES_ARE_SCATTERED           = 7354,  -- Boxes are carelessly scattered here
        NAIL_PULLER                   = 7355,  -- Boxes are carelessly scattered here. Perhaps you could open them with <item>
